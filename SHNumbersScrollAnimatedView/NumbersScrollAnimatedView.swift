...
class NumbersScrollAnimatedView: UIView {
    ...
    private func commonInit() {
        timeOffsetRule = NumbersScrollAnimatedView.randomTimeOffsetSetter
        durationOffsetRule = NumbersScrollAnimatedView.randomTimeOffsetSetter
